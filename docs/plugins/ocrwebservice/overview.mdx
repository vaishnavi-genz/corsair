---
title: Overview
description: "Cloud OCR service for converting PDFs and images into searchable text content."
---

Use **OCR Web Service** through Corsair: one client, typed API calls, local DB sync.
