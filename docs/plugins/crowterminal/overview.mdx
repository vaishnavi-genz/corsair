---
title: Overview
description: "Financial terminal API for market data, trading tools, and investment research workflows."
---

Use **Crow Terminal** through Corsair: one client, typed API calls, local DB sync, and incoming webhooks.
