---
title: Overview
description: "Amazon product data API for ASIN lookups, pricing, and marketplace intelligence."
---

Use **AsinData API** through Corsair: one client, typed API calls, local DB sync, and incoming webhooks.
